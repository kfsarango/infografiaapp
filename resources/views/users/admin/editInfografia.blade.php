        ...
        <div class="col-md-12">
            <div class="well well-sm">
                ...
                @csrf
                    ...
                    <div class="fotos">
                        <div class="fo">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-camera bigicon"> <input type="radio" name="numplan" id="cate" value="1"> Plantilla {{$info->plantilla}}</i></span>
                        </div>
                    </div>
